...
class HourlyMan(Employ):
    ...
    def cal_sal(self):
        return self.money_per_hour * self.work_hour
...
s1 = SalaryMan("김희철", 500000); s2 = SalaryMan("신동엽", 400000); s3 = SalaryMan("이영자", 380000);
h1 = HourlyMan("이영지", 10, 2000); h2 = HourlyMan("제시", 20, 18000); h3 = HourlyMan("제니", 15, 22000)
